        ...
        <>
            <div className="container mx-auto flex flex-col items-center justify-center min-h-screen gap-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 w-full left-0 right-0 top-0 bottom-0 p-4">
                    <Link href="/subjects" className="box bg-black text-white text-center text-xl p-6 rounded shadow-md hover:bg-blue-600 transition duration-300 ease-in-out">
                        Subject
                    </Link>
                ...
                <div className='grid grid-cols-1 gap-4 left-0 right-0 top-0 bottom-0 p-2 w-1/2'>
                    <Link href="/admin" className="box bg-black text-white text-center text-xl p-6 rounded shadow-md hover:bg-red-800 transition duration-300 ease-in-out">
                        Admin
                    </Link>
                </div>
            </div>
